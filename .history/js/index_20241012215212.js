...
listaSelecaoPokedevs.forEach(pokedev => {
  pokedev.addEventListener("click", () => {
    ...
    const cartaoPokedevParaAbrir = document.getElementsById(idDoCartaoPokedevParaAbrir);
    ...
    // PASSO 6 - Adicinar a classe ativo no pokedev selecionado na listagem
    const pokedevAtivoNaListagem = document.getElementById(idPokedevSelecionado);
    pokedevSe
  })
})
