...
listaSelecaoPokedevs.forEach(pokedev => {
   pokedev.addEventListener('click', () => {
      ...
      const idPokedevSelecionado = mostrarCartaoPokedevSelec(pokedev);

      // PASSO 5 - Remover a classe ativo que marca o pokedev selecionado na listagem
      destivarPokedevNaListagem();

      // PASSO 6 - Adicinar a classe ativo no pokedev selecionado na listagem
      AtivarPokedevAtivoNaListagem(idPokedevSelecionado);
   })
})

function AtivarPokedevAtivoNaListagem(idPokedevSelecionado) {
